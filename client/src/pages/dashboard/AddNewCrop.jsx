...
const AddNewCrop = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (user.userType !== "farmer") {
      setError("Only farmers can add crops");
      setLoading(false);
      return;
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Please log in to add crops</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Only farmers can add crops to the marketplace
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-indigo-50">
      ...
      {/* Main Content */}
      <div className="flex-1 lg:ml-0 py-8 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-blue-100">
              ...
              <p className="text-sm text-gray-600">
                Your crop will be visible to buyers immediately after
                submission.
              </p>
            </div>
